      ...
      <div className="container">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-5">
          {EXPECT_ITEMS.map((it) => (
            <div
              key={it.label}
              className="group relative overflow-hidden rounded-3xl border-2 border-ink bg-background shadow-brutal transition-transform hover:-translate-y-2"
            >
              <div className="relative h-52 w-full overflow-hidden border-b-2 border-ink">
                <img
                  src={it.img}
                  alt={it.label}
                  loading="lazy"
